                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row" style="border:#ddd 1px solid; background-color: white; margin-top: 5px;">
                                    <div class="col-md-12">
                                        <form action="<?php echo base_url('post/add_5'); ?>" method="POST"> 
                                            <fieldset style="height: auto !important;">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" value="<?php echo isset($_SESSION["name"]) ? $_SESSION["name"] : ''; ?>" name="username" class="form-control" required="required">
                                                </div>


                                                <h5 style="color:black;">Email*</h5>
                                                <div class="form-group">
                                                    <input type="email" value="<?php echo isset($_SESSION["email"]) ? $_SESSION["email"] : ''; ?>" name="email" class="form-control" required="required">
                                                </div>
