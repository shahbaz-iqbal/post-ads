                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row" style="border:#ddd 1px solid; background-color: white; margin-top: 5px;">
                                    <div class="col-md-12">
                                        <form action="<?php echo base_url('post/add_4'); ?>" method="POST"> 
                                            <fieldset style="height: auto !important;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" name="price" value="<?php echo isset($_SESSION["price"]) ? $_SESSION["price"] : ''; ?>" class="form-control" required="required">
                                                        </div>                                            
                                                    </div>
                                                    <div class="col-md-6">
                                                        <h5 style="color:black;">Currency*</h5>
                                                        <div class="form-group">
                                                            <select class="form-control" name="currency"  value="<?php echo isset($_SESSION["currency"]) ? $_SESSION["currency"] : ''; ?>" required="required">
                                                                <option>Select A Category</option>
                                                                <option value="DollarUS$" >DollarUS$</option>
