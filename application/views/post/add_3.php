                                            ...
                                            <fieldset style="height: auto !important;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" name="price" value="<?php echo isset($_SESSION["price"]) ? $_SESSION["price"] : ''; ?>" class="form-control">
                                                        </div>                                            
                                                    </div>
                                                    <div class="col-md-6">
                                                        <h5 style="color:black;">Currency</h5>
                                                        <div class="form-group">
                                                            <select class="form-control" name="currency"  value="<?php echo isset($_SESSION["currency"]) ? $_SESSION["currency"] : ''; ?>">
