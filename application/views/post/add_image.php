                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row" style="border:#ddd 1px solid; background-color: white; margin-top: 5px;">
                                    <div class="col-md-12">
                                        <form action="<?php echo base_url('post/add_image'); ?>" method="POST" enctype="multipart/form-data"> 
                                            <fieldset style="height: auto !important;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <input type="file" name="image" class="dropify form-control" data-height="300" />
