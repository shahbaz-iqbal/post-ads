                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row" style="border:#ddd 1px solid; background-color: white; margin-top: 5px;">
                                    <div class="col-md-12">
                                        <form action="<?php echo base_url('post/add_2'); ?>" method="POST"> 
                                            <fieldset style="height: auto !important;">
                                                ...
                                                <div class="form-group">
                                                    <input name="title" type="text" value="<?php echo isset($_SESSION["title"]) ? $_SESSION["title"] : ''; ?>" class="form-control" required="required">
                                                </div>
                                                <h5 style="color:black;">Website</h5>
                                                <div class="form-group">
                                                    <input type="text" name="web" value="<?php echo isset($_SESSION["web"]) ? $_SESSION["web"] : ''; ?>" class="form-control" >
                                                </div>
                                                <h5 style="color:black;">Discription</h5>
                                                <div class="form-group">
                                                    <textarea name="discription"  class="form-control" style="height: 200px;" required="required"><?php echo isset($_SESSION["discription"]) ? $_SESSION["discription"] : ''; ?></textarea>
                                                </div>
