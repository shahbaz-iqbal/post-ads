                    ...
                    <div class="site-section" style="padding: 0px;">
                        <div class="row mb-5">
                            <div class="col-md-7 text-left border-primary">
                                <h2 class="font-weight-light text-primary">Vehicals Category</h2>
                            </div>
                        </div>
                        <div class="container">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="d-block d-md-flex listing vertical">
                                                <a href="#" class="img d-block" style="background-image: url(<?php echo base_url('assets/images/img_1.jpg'); ?>)"></a>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="d-block d-md-flex listing vertical">
                                                <a href="#" class="img d-block" style="background-image: url(<?php echo base_url('assets/images/img_2.jpg'); ?>)"></a>
                                                <div class="lh-content">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="d-block d-md-flex listing vertical">
                                                <a href="#" class="img d-block" style="background-image: url(<?php echo base_url('assets/images/img_3.jpg'); ?>)"></a>
                                                <div class="lh-content">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="d-block d-md-flex listing vertical">
                                                <a href="#" class="img d-block" style="background-image: url(<?php echo base_url('assets/images/img_4.jpg'); ?>)"></a>
                                                <div class="lh-content">
